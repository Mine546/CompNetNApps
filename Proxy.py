...
while True:
  ...
  try:
    ...
    #from notes, just have to adjust connectionSocket into clientSocket
  ...
  try:
    ...
    # adapted from sentence = connectionSocket.recv(bytes)
    # buffer size is given in the skeleton above
